...
while t<=0.15:
    ...
    for i in range(N-1):
      #rho,u,p,e,H values
        ...
        #entropy fix
        for ii in range(3):
          if abs(Lambda[ii]) < epsilon:
            Lambda[ii] = 0.5*( Lambda[ii]*Lambda[ii]/epsilon + epsilon )
